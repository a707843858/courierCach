...
export class Config {
	...
	requestInterceptor: [((config: { [k: string]: any }) => any) | null, ((err: string) => string) | null] = [null, null];
	responseInterceptor: [((config: Response) => Response) | null, ((config: string) => string) | null] = [null, null];
